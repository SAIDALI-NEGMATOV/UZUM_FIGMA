  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Box>
            <Typography variant="h4">Обувь</Typography>
          </Box>
          ...
          <Box mt={"20px"} flexDirection={"column"} mr={"50px"}>
            ...
            <Box mb={"30px"}>
              ...
              <Box ml={"18px"}>
                <Box>
                  <Button
                    sx={{ color: "#5D5D5D", padding: "5px", fontSize: "10px" }}
                  >
                    Poyabzallar
                  </Button>
                </Box>
              ...
              >
                ...
                >
                  ...
                  <Box mt={"10px"} display={"flex"} position={"relative"}>
                    ...
                    <Button
                      onClick={() => itemLocal(item, index, Shoos)}
                      sx={{
                        mb: "10px",
                        position: "absolute",
                        top: "-5px",
